...
if(isset($_POST['key'])){
    ...
    if($_POST['key'] == 'user'){
        ...
        foreach($result as $row){
            ...
            $sub_array[] = $row["role"];
            $sub_array[] = '<button type="button" name="delete" id="'.$row["id"].'" class="btn btn-danger btn-xs delete"><i class="fas fa-trash"></i></button>';
            $sub_array[] = '<button type="button" name="update" id="'.$row["id"].'" class="btn btn-primary btn-xs update"><i class="fas fa-edit"></i></button>';
            $data[] = $sub_array;
        }
        ...
        foreach($result as $row){
            $sub_array = array();
            $sub_array[] = $row["name"];
            $sub_array[] = '<button type="button" name="deleteCollage" id="'.$row["id"].'" class="btn btn-danger  deleteCollage"><i class="fas fa-trash"></i></button>';
            $sub_array[] = '<button type="button" name="updateCollage" id="'.$row["id"].'" class="btn btn-primary  updateCollage"><i class="fas fa-edit"></i></button>';
            $sub_array[] = '<a href="dash/user/dept.php?id='.$row["id"].'&name='.$row["name"].'">show</a>';
            $data[] = $sub_array;
        }
        ...
        foreach($result as $row){
            ...
            $sub_array[] = '<button type="button" name="deleteTeacher" id="'.$row["tid"].'" class="btn btn-danger btn-xs deleteTeacher"><i class="fas fa-trash"></i></button>';
            $sub_array[] = '<button type="button" name="updateTeacher" id="'.$row["tid"].'" class="btn btn-primary btn-xs updateTeacher"><i class="fas fa-edit"></i></button>';
            $data[] = $sub_array;
        }
        ...
        foreach($result as $row){
            $sub_array = array();
            $sub_array[] = $row["name"];
            $sub_array[] = '<button type="button" name="deleteDept" id="'.$row["id"].'" class="btn btn-outline-danger btn-xs deleteDept"><i class="fas fa-trash"></i></button>';
            $sub_array[] = '<button type="button" name="updateDept" id="'.$row["id"].'" class="btn btn-outline-primary btn-xs updateDept"><i class="fas fa-edit"></i></button>';
            $data[] = $sub_array;
        }
