...
;(function (global, factory) {
	...
	Download.prototype.downloaders = {
		...
		pdf: function pdf(columns, data, options, setFileContents, config) {
			...
			var doc = new jsPDF(jsPDFParams); //set document to landscape, better for most tables
			 doc.addFont('Amiri-Bold', 'Amiri ', 'normal');
			 doc.setFont('Amiri ');
		...
		function success(value) {
			...
			if (self.currentCell === cell) {
				...
				if (valid === true) {
					...
					var now = 'update';
					var field = cell.element.getAttribute('tabulator-field');
					var id = cell.element.children[0].getAttribute('id');
					var table = cell.element.parentNode.parentNode.parentNode.parentNode.getAttribute('id');
					if(table == 'foreign')
					...
					if(field == 'end')
						field = 'end-date';
					if(field == 'RVDF')
						field = 'request-vacation-date-from';
					if(field == 'RVDT')
						field = 'request-vacation-date-to';
					...
					$.ajax({
						...
						success:function(data){
							if(cell.column.modules.edit.editor.name == "select" || field == 'pay')
								self.table.setData();
						}
					});
	...
	Edit.prototype.editors = {
		...
		//Create Date Editor
		dateEditor: function dateEditor(cell, onRendered, success, cancel){
